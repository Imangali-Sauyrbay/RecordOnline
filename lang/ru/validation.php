...
return [
    ...
    */
    ...
    'full_name' => 'ФИО должен быть в формате "Фамилия Имя Отчество" и не менее 2 символа каждый.',
    'group' => 'Группа должна быть в формате "ИП-19-3к5", "ИП-19-3т"...',
    ...
    'url' => 'Поле :attribute должен быть валидной ссылкой.',
